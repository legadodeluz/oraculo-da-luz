...
function Flame() {
  return (
    <div
      style={{ position: "relative", width: 60, height: 80, margin: "0 auto" }}
    >
      <div
        style={{
          position: "absolute",
          ...
          width: 12,
          height: 20,
          background: "linear-gradient(to top, #8B6914, #C8A84B)",
      ...
      <div
        style={{
          ...
          height: 28,
          background:
            "linear-gradient(to top, #fbbf24, #fef9c3, rgba(255,255,255,0.9))",
          borderRadius: "50% 50% 30% 30%",
...
export default function App() {
  ...
  useEffect(() => {
    const t = setInterval(
      () => setReflexao((p) => (p + 1) % REFLEXOES_INICIAIS.length),
      5000,
    );
    ...
    try {
      ...
      setMensagens([
        ...novas,
        {
          role: "assistant",
          content:
            "O silêncio também é uma resposta. Respire fundo e tente novamente...",
        },
      ]);
    }
    setCarregando(false);
  ...
  return (
    <div
      style={{
        ...
        width: "100%",
        background:
          "radial-gradient(ellipse at 20% 20%, #1a0a2e 0%, #0d0618 40%, #050210 100%)",
        display: "flex",
    ...
    >
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              transition: "all 0.3s",
              animation:
                "fadeUp 0.8s ease 1.3s both, pulse-gold 3s ease-in-out 2s infinite",
            }}
            onMouseOver={(e) => {
              e.currentTarget.style.background =
                "linear-gradient(135deg, rgba(139,100,20,0.6), rgba(200,168,75,0.35))";
          ...
          >
            Um espaço de reflexão e acolhimento.
            <br />
      ...
      {tela === "sobre" && (
        ...
        >
          ...
          {[
            {
              titulo: "O que é o Oráculo?",
              texto:
                "Um espaço digital de escuta, acolhimento e reflexão. Um lugar onde você pode colocar para fora o que está sentindo, sem julgamentos e sem pressa.",
            },
            {
              titulo: "De onde vem?",
              texto:
                "O Oráculo nasceu do canal Legado de Luz — um projeto dedicado a oferecer perspectiva espiritual para as jornadas da vida. Tudo aqui é feito com intenção genuína de ajudar.",
            },
            {
              titulo: "É seguro?",
              texto:
                "Suas conversas são privadas. O Oráculo é uma experiência de bem-estar com inteligência artificial. Não substitui acompanhamento psicológico ou médico profissional.",
            },
            {
              titulo: "Como apoiar?",
              texto:
                "Compartilhe com alguém que precise. Inscreva-se no canal Legado de Luz no YouTube. Sua presença já é um apoio.",
            },
          ].map((item, i) => (
            <div
              key={i}
          ...
          <button
            ...
            style={{
              ...
              gap: 8,
              background:
                "linear-gradient(135deg,rgba(139,100,20,0.3),rgba(200,168,75,0.15))",
        ...
        >
          ...
          >
            <button
              ...
              onMouseOut={(e) =>
                (e.currentTarget.style.color = "rgba(254,243,199,0.4)")
              }
            >
              ←
            </button>
                          ...
                          {[
                            ...
                            <button
                              ...
                              style={{
                                ...
                                borderRadius: 9,
                                color:
                                  velocidade === op.val ? "#fbbf24" : "#64748b",
                                fontSize: 10,
                                cursor: "pointer",
                                fontFamily: "inherit",
                                transition: "all .15s",
                              ...
                              style={{
                                ...
                                border:
                                  tom === op.val
                                    ...
                                    : "1px solid rgba(255,255,255,0.07)",
                                borderRadius: 9,
                                color: tom === op.val ? "#6EE7B7" : "#64748b",
                                fontSize: 10,
                                cursor: "pointer",
                                fontFamily: "inherit",
                                transition: "all .15s",
          ...
          >
            ...
            {mensagens.length === 0 && (
              ...
              >
                ...
                >
                  {
                    OPENING_PHRASES[
                      Math.floor(Math.random() * OPENING_PHRASES.length)
                    ]
                  }
                </p>
                ...
                >
                  Este é um espaço sagrado de escuta.
                  <br />
            ...
            {mensagens.map((msg, i) => (
              <Mensagem key={i} msg={msg} index={i} />
            ))}
            ...
            {mostrarCVV && (
              ...
              >
                ...
                >
                  O Oráculo está aqui para ouvir. Mas se você estiver passando
                  por um momento muito difícil, existe apoio humano e gratuito
                  disponível agora.
                </p>
                <p
                  style={{
                ...
                >
                  📞 Ligue <strong style={{ color: "#fca5a5" }}>188</strong> —
                  gratuito, 24h, sigiloso
                </p>
                <button
                  onClick={() => setMostrarCVV(false)}
                  style={{
                    background: "none",
                    border: "none",
