                        ...
                        <div style={{ display:"flex", gap:5, justifyContent:"center", marginBottom:10 }}>
                          {[
                            ...
                            <button key={op.val} onClick={()=>setVelocidade(op.val)}
                              style={{ flex:1, padding:"6px 4px", background: velocidade===op.val?"rgba(251,191,36,0.15)":"rgba(255,255,255,0.04)", border:, borderRadius:9, color: velocidade===op.val?"#fbbf24":"#64748b", fontSize:10, cursor:"pointer", fontFamily:"inherit", transition:"all .15s" }}>
                              {op.label}
                            </button>
                          ))}
                        </div>
                        ...
                        <div style={{ display:"flex", gap:5, justifyContent:"center" }}>
                          {[
                            ...
                            <button key={op.val} onClick={()=>setTom(op.val)}
                              style={{ flex:1, padding:"6px 4px", background: tom===op.val?"rgba(110,231,183,0.12)":"rgba(255,255,255,0.04)", border:, borderRadius:9, color: tom===op.val?"#6EE7B7":"#64748b", fontSize:10, cursor:"pointer", fontFamily:"inherit", transition:"all .15s" }}>
                              {op.label}
                            </button>
                          ))}
                        </div>
